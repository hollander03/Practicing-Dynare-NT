...
\begin{abstract}
This paper teaches Dynare by applying it to approximate equilibria and estimate nine dynamic economic models. We hope that it illustrates once again the efficacy of learning by doing.
\end{abstract}
